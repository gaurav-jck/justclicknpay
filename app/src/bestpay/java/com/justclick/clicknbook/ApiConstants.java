...
public class ApiConstants
{
    ...
    public static final String BASE_URL_LIVE="https://ms.bestpay.org.in/";
...
//    public static final String BASE_URL_JCT_MONEY="https://mb.justclicknpay.com/";  //new live jct url (please uncomment this for live)
    public static final String BASE_URL_JCT_MONEY="https://wlremittance.justclicknpay.com/";  //new live jct url (please uncomment this for live)
    ...
    public static final String BASE_URL_RAPIPAY="https://wlremittance.justclicknpay.com/";  //live rapipay url
    ...
    public static final String BASE_URL_TEST2="http://uatms.justclicknpay.com:116/";
    public static final String BASE_URL_LIVE="https://ms.bestpay.org.in/";
    //    public static final String BASE_URL_LIVE="https://mob.bestpay.org.in/";
    public static final String BASE_URL=BASE_URL_LIVE;
    //    public static final String BASE_URL_JCT_MONEY="http://uatmb.justclicktravels.com/";  //test jct money url
    public static final String BASE_URL_JCT_MONEY="https://mb.justclicknpay.com/";  //new live jct url (please uncomment this for live)
    ...
    public static final String BASE_URL_RAPIPAY="https://wlremittance.justclicknpay.com/";  //live rapipay url
    public static final String BASE_URL_RAPIPAY_MATM="https://matm.justclicknpay.com/";  //live rapipay url
//    public static final String BASE_URL_PAYOUT="https://wluatcashout.justclicknpay.com/";  //test payout url
    public static final String BASE_URL_PAYOUT="https://wlpayout.justclicknpay.com/";  //live payout url
    public static final String PATH_URL_PAYOUT="api/Cashfree/";  //path payout url
    ...
    public static final String MerchantId="BESTPAY";
    ...
    public static final String CashfreeTrans="CashfreeTrans";
