...
import com.justclick.clicknbook.databinding.FragmentInstaPayBillDirectBinding
...
class InstaBillPayDirectFragment : Fragment() {
    private val ARG_PARAM1 = "param1"
    private val ARG_PARAM2 = "param2"
    private val ARG_PARAM3 = "param3"
    private val ARG_PARAM4 = "param4"
    private var binding: FragmentInstaPayBillDirectBinding?=null
    ...
    companion object {
        fun newInstance(
            ...
            InstaBillPayDirectFragment().apply {
    ...
    override fun onCreateView(
        ...
        binding= FragmentInstaPayBillDirectBinding.inflate(layoutInflater)

        binding!!.topView.titleTv.text= "$billType Bill Pay"
        binding!!.personDetailTv.text= "$billType Bill Detail"

        binding!!.nameEdt.setText(billerRequest!!.OperatorName)
        binding!!.billNoEdt.setText(billerRequest!!.Param1)
    ...
    private fun fetchBillDetails() {
        ...
        if(amount.isEmpty()){
            ...
            Toast.makeText(requireContext(), "Please enter amount between 3 to 1500000", Toast.LENGTH_SHORT).show()
    ...
    private fun payBill() {
        ...
        request.Amount = binding!!.amountEdt.text.toString()
...
//                        Common.showSuccessDialog(requireContext(),response.StatusMessage)
    ...
    private fun openReceipt(responseModel: PayBillInstaResponse) {
        ...
        val nameLabel = dialog.findViewById<TextView>(R.id.nameLabel)
        ...
        nameLabel.setText("Operator name")
        nameTv.setText(billerRequest!!.OperatorName)
