...
//                myViewHolder.account.setText("M. "+info.getMobile());
...
//                for refund
                if(/*info.getTxnStatus().equals("1") || */info.getTxnStatus().equals("3")){
                    myViewHolder.refundLin.setVisibility(View.VISIBLE);
                }else {
                    myViewHolder.refundLin.setVisibility(View.GONE);
                }
                myViewHolder.refundLin.setOnClickListener(v -> listener.onRecyclerItemClick(myViewHolder.refundLin,
                        (ArrayList<TxnListResponseModel.transactionListDetail>) infoList,info,position));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            jckTxnId =  itemView.findViewById(R.id.txnId);
            txnAmount =  itemView.findViewById(R.id.txnAmountTv);
            bankName =  itemView.findViewById(R.id.bankNameTv);
            ifsc =  itemView.findViewById(R.id.ifscTv);
            mobile =  itemView.findViewById(R.id.senderMobileTv);
            account =  itemView.findViewById(R.id.accountNoTv);
            date =  itemView.findViewById(R.id.txnDateTv);
            status =  itemView.findViewById(R.id.statusTv);
            txnType =  itemView.findViewById(R.id.txnType);
            print_tv =  itemView.findViewById(R.id.print_tv);
            refundLin = itemView.findViewById(R.id.refundLin);
        }
    }
