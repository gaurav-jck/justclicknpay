package com.justclick.clicknbook.Fragment.billpayinsta
...
class InstaBillpayDashboardFragment : Fragment(), View.OnClickListener {
    ...
    private var binding:FragmentInstaBillpayDashboardBinding?=null
    ...
    companion object {
        fun newInstance() = InstaBillpayDashboardFragment()
    }
