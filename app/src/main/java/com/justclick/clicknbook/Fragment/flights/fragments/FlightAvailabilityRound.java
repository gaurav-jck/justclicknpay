...
import com.justclick.clicknbook.Fragment.flights.adapters.RecyclerReturnFlightAdapter;
...
public class FlightAvailabilityRound extends Fragment implements View.OnClickListener {
    ...
    private RecyclerReturnFlightAdapter flightAdapter;
    private TextView tv_from , tv_to, tv_dep_date, tv_total_traveller, tv_total_flight;
    private TextView tv_dep_sort, tv_arr_sort, tv_dur_sort, tv_price_sort;
    ...
    private TextView selectFlightDestTv, totalFlightsTv;
...
// flight arraylist set adapter and  details
        setFlightAdapter();
        setFlightList();
...
//                    Toast.makeText(context, "apply", Toast.LENGTH_SHORT).show();
    ...
    private void initializeView() {
        ...
        tv_dep_date.setText(FlightUtils.getFormatDate(departureDate)+"-"+FlightUtils.getFormatDate(arrivalDate)
                +" | "+ totalTraveller + " Traveller"+" | ");
    ...
    private void setFlightAdapter() {
        flightAdapter = new RecyclerReturnFlightAdapter(context, flightArrayListTemp, new RecyclerReturnFlightAdapter.FlightAdapetrListener() {
            @Override
            public void onClickAtAdapter(int position) {
                Fragment fragment2 = new FlightDetails();
