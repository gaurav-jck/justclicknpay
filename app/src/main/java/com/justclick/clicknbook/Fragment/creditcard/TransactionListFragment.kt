...
class TransactionListFragment : Fragment(), View.OnClickListener {
    ...
    private var listAdapter: UtilityRecyclerTransactionList? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var binding=ActivityTxnListBinding.inflate(layoutInflater);
...
//        addValueToModel();
        listAdapter = UtilityRecyclerTransactionList(context, UtilityRecyclerTransactionList.OnRecyclerItemClickListener { view, list, data, position ->
            when (view.id) {
                R.id.print_tv -> try {
...
//        transactionListRequestModel!!.setUserType("OOU") // hardcode
        transactionListRequestModel!!.rechargeType="CCBILLPAY"
        transactionListRequestModel!!.setUserType(loginModel!!.Data.UserType)
//        transactionListRequestModel!!.setAgentCode(loginModel!!.Data.DoneCardUser)
