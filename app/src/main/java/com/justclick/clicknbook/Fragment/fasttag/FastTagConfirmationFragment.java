...
public class FastTagConfirmationFragment extends Fragment {
    ...
    public FastTagConfirmationFragment() {
    ...
    private void setValues() {
        ...
        idEdt.setText(billDetail.cellNumber);
    ...
    class PayBillRequest{
        public String Operatorid,operatorid,Canumber,billdate,dueDate,cellNumber,userName,AgentCode,Email,Suppliercode,Category,fetchbillstring;
...
//        title.setText(billDetail.category+" Bill Receipt");
        title.setText("FastTag"+" Bill Receipt");
    ...
    private void payBill(String userData, String token) {
        ...
        request.operatorid=billDetail.operatorid;
        request.Canumber=billDetail.cellNumber;
        request.cellNumber=billDetail.cellNumber;
        ...
        request.BillAmount= Float.parseFloat(amountEdt.getText().toString().trim());
        request.Billnetamount= Float.parseFloat(amountEdt.getText().toString().trim());
//        request.BillAmount= 1.0f;
//        request.Billnetamount=1.0f;
        showCustomDialog();
        String json = new Gson().toJson(request);
        new NetworkCall().callService(NetworkCall.getFastTagApiInterface().payFastTagBill(request, userData, token), context, false, (response, responseCode) -> {
            hideCustomDialog();
