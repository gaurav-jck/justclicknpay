...
public class RapipayTxnDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    private Context context;
    private ArrayList<TransactionResponse.transactionDetails> arrayList;
    ...
    public RapipayTxnDetailAdapter(Context context, OnRecyclerItemClickListener fragment,
                                   ArrayList<TransactionResponse.transactionDetails> arrayList) {
