...
class InstaDmtTransactionListFragment : Fragment(), View.OnClickListener {
...
//        transactionListRequestModel!!.AgentId=agentDoneCard
        ...
        NetworkCall().callService(NetworkCall.getDmtInstaApiInterface().getInstaCredPost(
                ApiConstants.DmtTransactionList, transactionListRequestModel), context, false
