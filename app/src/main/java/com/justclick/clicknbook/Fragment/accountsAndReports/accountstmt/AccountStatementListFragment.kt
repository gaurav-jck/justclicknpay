...
//            R.id.lin_dateFilter -> openFilterDialog()
            R.id.lin_dateFilter -> createExcelSheet()
            R.id.linFilter -> {
...
//    https://medium.com/geekculture/creating-an-excel-in-android-cd9c22198619
    private fun createExcelSheet() {
        ...
        try {
            ...
            val sheet: WritableSheet = workbook.createSheet("First Sheet", 0)
            val label = Label(0, 2, "SECOND")
            val label1 = Label(0, 1, "first")
            val label0 = Label(0, 0, "HEADING")
            val label3 = Label(1, 0, "Heading2")
