...
class CashFreeQRCodeFragment : Fragment() {
    ...
    private fun getCredentials() {
        ...
        NetworkCall().callService(NetworkCall.getCashFreeQRApiInterface().getQRAuth(ApiConstants.Authentication, request), context, true
...
//        builder.setIcon(android.R.drawable.ic_dialog_alert)
    ...
    private fun generateQr(qrCode: String?) {
        /*val manager = getSystemService(context!!,) as WindowManager?
