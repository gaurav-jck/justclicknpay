...
public class MyHotelCitySearchDialog {
...
//    private static ListView list_agent;
    ...
    public static void showCustomDialog(final Context context, final String msg, final int key, HotelSearchFragmentKotlin searchFragment){
        try {
            onCityDialogResult= (OnCityDialogResult) searchFragment;
            ...
            MyHotelCitySearchDialog.context=context;
            TextView searchTitleTv= dialog.findViewById(R.id.searchTitleTv);
            searchTitleTv.setText("Search City");
