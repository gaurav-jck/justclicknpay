...
public class RecyclerRecentTransaction extends RecyclerView.Adapter<RecyclerRecentTransaction.MyViewHolder>{

    Context context;
    List<TransactionInfo> infoList;

    public RecyclerRecentTransaction(Context activity, List<TransactionInfo> infoList) {
...
//        }
        ...
        holder.tv_description.setText(info.getTransactionMessage());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_name, tv_amount, tv_rbl_request,tv_description;
