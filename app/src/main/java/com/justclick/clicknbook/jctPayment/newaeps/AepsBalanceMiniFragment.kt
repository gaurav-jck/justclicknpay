...
import com.justclick.clicknbook.databinding.ActivityAepsBalMiniBinding
...
public class AepsBalanceMiniFragment(Type: String, aepsPipe: String) : Fragment() {
    //https://developers.google.com/identity/sign-in/android/sign-in
    private val BAL_ENQ = "BE"
    ...
    lateinit var binding:ActivityAepsBalMiniBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding= ActivityAepsBalMiniBinding.inflate(inflater)

        if (TYPE.equals(BAL_ENQ)) {
            binding.titleTv.text="Balance Enquiry"
            URL = URLs.AepsBalanceCheck
//            URL =URLs.AepsAuthenticate;
        } else {
            binding.titleTv.text="Mini Statement"
            URL = URLs.AepsBankStatment
        }
