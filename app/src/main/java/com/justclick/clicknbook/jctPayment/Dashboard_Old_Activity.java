...
import com.justclick.clicknbook.jctPayment.Fragments.Services_Fragment_old;
...
public class Dashboard_Old_Activity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Transactions_Fragment(), "Transactions");
        adapter.addFragment(new Services_Fragment_old(), "Services");
