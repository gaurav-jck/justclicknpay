...
import com.justclick.clicknbook.databinding.ActivityAepsKyc1Bank2Binding
...
class AepsKyc1Bank2Fragment(aepsPipe: String) : Fragment() {
    ...
    lateinit var binding:ActivityAepsKyc1Bank2Binding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
        ...
        binding= ActivityAepsKyc1Bank2Binding.inflate(inflater)
        ...
        binding.btnCapture.setOnClickListener { v: View? ->
            ...
            if (!Common.isMobileValid(mobileNo)) {
                ...
                Toast.makeText(context, "Please select DOB", Toast.LENGTH_SHORT)
                    .show()
            }else{
...
//        sessionCheckMethod(false);
    ...
    private fun sendMobileTransaction() {
        ...
        params["DOB"] = dateToSend!!
        params["pipe"] = "bank2"
//        params["bankPipe"] = ""
//        params["is_casa"] = str_aadhar!!
...
//        binding.pid.setText(pidDataXML)
        ...
        val call = apiService.getAepsHeaderMap(URLs.bank2ekyc, params, MyPreferences.getUserData(context),
...
//                    Toast.makeText(context, senderResponse.statusMessage, Toast.LENGTH_LONG).show()
    ...
    private fun initializeDates() {
        ...
        dateFormat = Common.getShowInTVDateFormat()
    ...
    private fun selectDob() {
        val datePickerDialog = DatePickerDialog(requireContext(),
            ...
            { view, year, monthOfYear, dayOfMonth ->
                ...
                startDateYear = year
                binding!!.dobEdt!!.setText(dateFormat!!.format(startDateCalendar!!.time))
