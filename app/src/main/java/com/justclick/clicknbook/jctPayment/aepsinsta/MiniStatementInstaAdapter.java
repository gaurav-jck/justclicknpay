...
public class MiniStatementInstaAdapter extends RecyclerView.Adapter<MiniStatementInstaAdapter.ViewHolder> {

    Context context;
    int count;
    List<AepsInstaResponse.msDetails> detailsList;

    public MiniStatementInstaAdapter(Context activity, List<AepsInstaResponse.msDetails> infoList) {
