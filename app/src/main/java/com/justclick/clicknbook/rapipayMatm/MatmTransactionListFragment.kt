...
class MatmTransactionListFragment : Fragment(), View.OnClickListener {
...
//            if (!isLoading && !isLastPage) {
    ...
    fun callAgent(transactionListRequestModel: TxnListRequestModel?, progress: Boolean) {
        ...
        NetworkCall().callRapipayMatmListService(transactionListRequestModel, ApiConstants.TransactionListMatm, context
        ) { response, responseCode ->
            if (response != null) {
