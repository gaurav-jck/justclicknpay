...
public class CreditListForAgentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    private static final int TYPE_HEADER = 0;
    private static final int TYPE_ITEM = 1;
    private static final int TYPE_FOOTER = 2;
    private Context context;
    private OptModel OptModel;
    private ArrayList<CreditListForAgentModel.CreditReportData> arrayList;
    ...
    public CreditListForAgentAdapter(Context context, OnRecyclerItemClickListener fragment, ArrayList<CreditListForAgentModel.CreditReportData> arrayList, int totalPageCount) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.credit_report_list_item_for_agent, parent, false);
        ...
        try {
          //  Name,updated_by_tv,request_date_tv,request_amount_tv,credit_date_tv,credit_amount_tv;
            if (holder!=null && holder instanceof MyViewHolder) {
                ...
                vh.credit_amount_tv.setText(arrayList.get(position).CreditedAmount);
                vh.remarksTv.setText(arrayList.get(position).Remarks);
                ...
                vh.remarksTv.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                       /* Toast.makeText(context, vh.remarksTv.getText().toString().length()+"\n"+
                                arrayList.get(position).Remarks.length(), Toast.LENGTH_LONG).show();
*/
                        ...
                        textView.setText(arrayList.get(position).Remarks);
